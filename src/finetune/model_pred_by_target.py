...
class BinaryClassifierByTARGET(pl.LightningModule):
    def __init__(self, model_name="bert-base-uncased", lr=2e-5, dropout_rate=0.1, concat_or_mean: Literal['concat', 'mean'] ='concat', save_transformer_model_path=None):
        super().__init__()
        # learning rate
        self.lr = lr
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = self.criteria(logits.view(-1), batch['labels'].float())
